...
def main():
    ...
    proz    = [gui.Text("Progress...    ", key="percent",font=("Arial", 10)), gui.ProgressBar(1, key="progress", orientation="h", size=(53,25))]
    down    = [gui.Button("Download",font=("Arial", 11), size=(61,1))]
    
    #making frame layout from widgets
    framelayout     = [browser, url, v_name, down] 
